...
export default function Withdraw({ isOpen, onClose, client }) {
    if (!isOpen) return null;
    return (
        <div className="modal-overlay">
            <div className="modal-box">
                <div className="modal-header">
                    <h3 style={{ textAlign: "center" }}>Withdraw Chips ({client?.name})</h3>
                ...
                <div className="modal-body">
                    <div className="form-group" style={{ padding: "15px 10px" }}>
                        <label>Withdraw Chips:&nbsp; <input type="text" className="form-control-in" /></label>
                    </div>
