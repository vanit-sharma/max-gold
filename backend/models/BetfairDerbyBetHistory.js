...
const BetfairDerbyBetHistorySchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_derby_bet_history",
    versionKey: false
  }
);

BetfairDerbyBetHistorySchema.index({ uname: 1 });
BetfairDerbyBetHistorySchema.index({ cat_mid: 1 });

module.exports = mongoose.model("BetfairDerbyBetHistory", BetfairDerbyBetHistorySchema);