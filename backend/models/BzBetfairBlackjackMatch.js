...
const BzBetfairBlackjackMatchSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_blackjack_match",
    versionKey: false
  }
);

/*
BzBetfairBlackjackMatchSchema.index({ uname: 1 });
BzBetfairBlackjackMatchSchema.index({ mid_mid: 1 });
BzBetfairBlackjackMatchSchema.index({ stld: 1 });
*/

module.exports = mongoose.model("BzBetfairBlackjackMatch", BzBetfairBlackjackMatchSchema);
