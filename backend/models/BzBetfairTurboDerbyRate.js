...
const BetfairTurboDerbyRateSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_turbo_card_rates",
    versionKey: false
  }
);

BetfairTurboDerbyRateSchema.index({ evt_id: 1 });
BetfairTurboDerbyRateSchema.index({ evt_od: 1 });
BetfairTurboDerbyRateSchema.index({ cat_mid: 1 });
BetfairTurboDerbyRateSchema.index({ evt_status: 1 });
BetfairTurboDerbyRateSchema.index({ game_type: 1 });
BetfairTurboDerbyRateSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model("BetfairTurboDerbyRate", BetfairTurboDerbyRateSchema);