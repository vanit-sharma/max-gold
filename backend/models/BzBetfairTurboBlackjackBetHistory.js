...
const BzBetfairTurboBlackjackBetHistorySchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_turbo_blackjack_bet_history",
    versionKey: false
  }
);


module.exports = mongoose.model("BzBetfairTurboBlackjackBetHistory", BzBetfairTurboBlackjackBetHistorySchema);
