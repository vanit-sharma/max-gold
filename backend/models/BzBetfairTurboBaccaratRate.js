...
const BzBetfairTurboBaccaratRateSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_turbo_baccarat_rates",
    versionKey: false
  }
);

BzBetfairTurboBaccaratRateSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model("BzBetfairTurboBaccaratRate", BzBetfairTurboBaccaratRateSchema);
