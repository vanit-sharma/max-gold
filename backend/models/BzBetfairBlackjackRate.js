...
const BzBetfairBlackjackRateSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_blackjack_rates",
    versionKey: false,
  }
);

//BzBetfairBlackjackRateSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model("BzBetfairBlackjackRate", BzBetfairBlackjackRateSchema);
