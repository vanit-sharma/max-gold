...
const BetfairOmahaRateSchema = new Schema(
  {
    ...
    rnr9_status: { type: String, required: true },
  ...
  {
    collection: "bz_betfair_omaha_rates",
    versionKey: false
  }
);

BetfairOmahaRateSchema.index({ evt_id: 1 });
BetfairOmahaRateSchema.index({ evt_od: 1 });
BetfairOmahaRateSchema.index({ cat_mid: 1 });
BetfairOmahaRateSchema.index({ evt_status: 1 });
BetfairOmahaRateSchema.index({ game_type: 1 });
BetfairOmahaRateSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model("BetfairOmahaRate", BetfairOmahaRateSchema);