...
const BzBetfairBaccaratRateSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_baccarat_rates",
    versionKey: false
  }
);

BzBetfairBaccaratRateSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model("BzBetfairBaccaratRate", BzBetfairBaccaratRateSchema);
