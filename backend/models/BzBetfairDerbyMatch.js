...
const BetfairDerbyMatchSchema = new Schema(
  {
  ...
  {
    collection: "bz_betfair_derby_match",
    versionKey: false
  }
);

BetfairDerbyMatchSchema.index({ uname: 1 });
BetfairDerbyMatchSchema.index({ cat_mid: 1 });

module.exports = mongoose.model("BzBetfairDerbyMatch", BetfairDerbyMatchSchema);