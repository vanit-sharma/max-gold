...
var betTeenpattiT20VirtualSchema = new Schema({
  ...
  collection: 'bet_teenpatti_t20_virtual'
});

betTeenpattiT20VirtualSchema.index({ id: 1 }, { unique: true });
betTeenpattiT20VirtualSchema.index({ evt_od: 1 });
betTeenpattiT20VirtualSchema.index({ cat_mid: 1 });
betTeenpattiT20VirtualSchema.index({ evt_status: 1 });

module.exports = mongoose.model('BetTeenpattiT20Virtual', betTeenpattiT20VirtualSchema);