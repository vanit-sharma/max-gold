...
var bzUserBetTp20GalaxySchema = new Schema(
  {
  ...
  {
    collection: "bz_user_bet_tp_20_galaxy",
  }
);

bzUserBetTp20GalaxySchema.index({ uname: 1 });
bzUserBetTp20GalaxySchema.index({ cat_mid: 1 });
bzUserBetTp20GalaxySchema.index({ cat_mid: 1, stld: 1 });

module.exports = mongoose.model(
  "BzUserBetTp20Galaxy",
  bzUserBetTp20GalaxySchema
);
