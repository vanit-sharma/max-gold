...
var bzBetsLucky7GalaxyHistorySchema = new Schema({
  ...
  collection: 'bz_bets_lucky7_galaxy_history'
});

bzBetsLucky7GalaxyHistorySchema.index({ uname: 1 });
bzBetsLucky7GalaxyHistorySchema.index({ cat_mid: 1 });

module.exports = mongoose.model('BzBetsLucky7GalaxyHistory', bzBetsLucky7GalaxyHistorySchema);
