...
var betTeenpattiT20GalaxySchema = new Schema({
  ...
  collection: 'bet_teenpatti_t20_galaxy'
});


betTeenpattiT20GalaxySchema.index({ evt_od: 1 });
betTeenpattiT20GalaxySchema.index({ cat_mid: 1 });
betTeenpattiT20GalaxySchema.index({ evt_status: 1 });


module.exports = mongoose.model('BetTeenpattiT20Galaxy', betTeenpattiT20GalaxySchema);
