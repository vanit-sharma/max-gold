...
var bzBetRatesHighcardVirtualSchema = new Schema({
  ...
  collection: 'bz_bet_rates_highcard_virtual'
});

bzBetRatesHighcardVirtualSchema.index({ sno: 1 }, { unique: true });
bzBetRatesHighcardVirtualSchema.index({ evt_id: 1 });
bzBetRatesHighcardVirtualSchema.index({ evt_od: 1 });
bzBetRatesHighcardVirtualSchema.index({ cat_mid: 1 });
bzBetRatesHighcardVirtualSchema.index({ evt_status: 1 });
bzBetRatesHighcardVirtualSchema.index({ game_type: 1 });
bzBetRatesHighcardVirtualSchema.index({ evt_status: 1, stld: 1 });

module.exports = mongoose.model('BzBetRatesHighcardVirtual', bzBetRatesHighcardVirtualSchema);