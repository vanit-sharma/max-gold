...
var HeadtailMatchSchema = new Schema({
  ...
  result_data: { type: Object, default: null }
}, {
  collection: 'headtail_match',
  timestamps: false
});

module.exports = mongoose.model('HeadtailMatch', HeadtailMatchSchema);