...
var RouletteBethistorySchema = new Schema({
...
}, { collection: 'roulette_bethistory' });

RouletteBethistorySchema.index({ uname: 1 });
RouletteBethistorySchema.index({ cat_mid: 1 });
RouletteBethistorySchema.index({ user_id: 1 });

module.exports = mongoose.model('RouletteBethistory', RouletteBethistorySchema, 'roulette_bethistory');