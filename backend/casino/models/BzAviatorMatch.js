...
const BzAviatorMatchSchema = new Schema({
...
section_no: { type: Number, required: true, default: 0 }
}, { collection: 'bz_aviator_match' });

BzAviatorMatchSchema.index({ uname: 1 });
BzAviatorMatchSchema.index({ mid_mid: 1 });
BzAviatorMatchSchema.index({ stld: 1 });
BzAviatorMatchSchema.index({ user_id: 1 });

module.exports = mongoose.model('BzAviatorMatch', BzAviatorMatchSchema, 'bz_aviator_match');